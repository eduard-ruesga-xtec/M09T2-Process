...
namespace M09T2.Act6
{
    public class Camel
    {
        ...
        private readonly object _locker = new();                       //No es obligatori, en servirà per protegir els colors de la consola
        ...
        public void Run()
        {
            ...
            for (int i = 0; i < Goal; i++)
            {
                ...
                lock (_locker)                           //Console és un recurs comú que bloquejem
                {
